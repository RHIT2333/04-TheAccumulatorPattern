...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(3, 9, 0.76)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(3, 9, -0.6)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 5
    answer = count_cosines_from(3, 9, -0.90)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.818117  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(16, 95)
